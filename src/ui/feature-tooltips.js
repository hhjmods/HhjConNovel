...
const descriptions = [
  ...
  ['.story-tools .con-size-toggle', '대왕콘 전환', '일반콘과 대왕콘 크기를 전환합니다. 여러 콘을 선택했다면 함께 바뀝니다. 대왕콘은 디시에서 대왕콘 미션을 완료해야만 글을 쓸때 실제로 적용됩니다. 당일 글 10개, 댓글 20개 작성 시 대왕디시콘을 3일간 사용할 수 있습니다. 대왕콘 마이너 갤러리를 활용하는것을 추천합니다.'],
